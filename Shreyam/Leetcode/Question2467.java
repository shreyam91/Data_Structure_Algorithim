// Question: Most Profitable Path in a Tree... 
...
public class Question2467 {
    private static boolean findBobPath(List<List<Integer>> adj, int bob, int parent, List<Integer> currPath, List<Integer> bobPath) {
        if (bob == 0) {
    ...
    private static int findMaxIncomeForAlice(List<List<Integer>> adj, int alice, int parent, int[] amount) {
